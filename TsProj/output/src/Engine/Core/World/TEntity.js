...
(function (NT) {
     ...
     */
    class TEntity extends NT.TObject {
        _children = [];
        _parent;
        _isLoaded = false;
        _sceneGraph;
        ...
        _behaviors = [];
        _isVisible = true;
        _localMatrix = NT.Matrix4x4.identity();
        _worldMatrix = NT.Matrix4x4.identity();
        /** The name of this object. */
        name;
        /** The transform of this entity. */
        transform = new NT.Transform();
        /**
        ...
        */
        ...
        getWorldPosition() {
            return new NT.Vector3(this._worldMatrix.data[12], this._worldMatrix.data[13], this._worldMatrix.data[14]);
        }
        /**
        ...
        updateWorldMatrix(parentWorldMatrix) {
            if (parentWorldMatrix !== undefined) {
                this._worldMatrix = NT.Matrix4x4.multiply(parentWorldMatrix, this._localMatrix);
            }
            else {
