...
(function (NT) {
    ...
    })(LevelState = NT.LevelState || (NT.LevelState = {}));
    /**
    ...
    class Level {
        ...
        constructor(name, description) {
            ...
            this._sceneGraph = new NT.SceneGraph();
        }
        ...
        loadEntity(dataSection, parent) {
            ...
            if (dataSection.type !== undefined) {
                ...
                entity = new NT.TEntity(name, this._sceneGraph);
            }
            ...
            if (dataSection.components !== undefined) {
                for (let c in dataSection.components) {
                    ...
                    let component = NT.ComponentManager.extractComponent(data);
            ...
            if (dataSection.behaviors !== undefined) {
                for (let b in dataSection.behaviors) {
                    ...
                    let behavior = NT.BehaviorManager.extractBehavior(data);
