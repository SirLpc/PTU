...
(function (NT) {
    ...
    class Engine {
        ...
        update(delta) {
            NT.MessageBus.update(delta);
            if (NT.LevelManager.isLoaded && NT.LevelManager.activeLevel !== undefined && NT.LevelManager.activeLevel.isLoaded) {
                NT.LevelManager.activeLevel.update(delta);
            }
