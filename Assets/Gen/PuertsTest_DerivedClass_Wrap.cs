        ...
        private static void M_ParamsFunc(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, 1, paramLen))
