...
{
    public static class Puergp_Variables_BaseVariable_1_UnityEngine_GameObject__Wrap
    {
        ...
        private static void M_GetValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puergp.Variables.BaseVariable<UnityEngine.GameObject>;
        ...
        private static void S_value(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                obj.value = argHelper.Get<UnityEngine.GameObject>(false);
