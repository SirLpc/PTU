...
{
    public static class Puergp_Variables_BaseVariable_1_System_Single__Wrap
    {
        ...
        private static void M_GetValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puergp.Variables.BaseVariable<float>;
