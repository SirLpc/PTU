    ...
    public static class Puerts_JsEnv_Wrap
    {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    new Puerts.LazyMemberRegisterInfo() { Name = "OnJsEnvCreate", IsStatic = true, Type = (Puerts.LazyMemberType)4, HasGetter = true, HasSetter = true },
                    new Puerts.LazyMemberRegisterInfo() { Name = "OnJsEnvDispose", IsStatic = true, Type = (Puerts.LazyMemberType)4, HasGetter = true, HasSetter = true },
                    new Puerts.LazyMemberRegisterInfo() { Name = "debugPort", IsStatic = false, Type = (Puerts.LazyMemberType)4, HasGetter = true, HasSetter = true }
                }
            };
        }
