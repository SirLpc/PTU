    ...
    public static class UnityEngine_CanvasRenderer_Wrap
    {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    new Puerts.LazyMemberRegisterInfo() { Name = "add_onRequestRebuild", IsStatic = true, Type = (Puerts.LazyMemberType)2, HasGetter = false, HasSetter = false },
                    new Puerts.LazyMemberRegisterInfo() { Name = "remove_onRequestRebuild", IsStatic = true, Type = (Puerts.LazyMemberType)2, HasGetter = false, HasSetter = false }
                }
            };
        }
