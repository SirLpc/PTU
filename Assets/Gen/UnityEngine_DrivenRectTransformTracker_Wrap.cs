    ...
    public static class UnityEngine_DrivenRectTransformTracker_Wrap
    {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    new Puerts.LazyMemberRegisterInfo() { Name = "StopRecordingUndo", IsStatic = true, Type = (Puerts.LazyMemberType)2, HasGetter = false, HasSetter = false },
                    new Puerts.LazyMemberRegisterInfo() { Name = "StartRecordingUndo", IsStatic = true, Type = (Puerts.LazyMemberType)2, HasGetter = false, HasSetter = false }
                }
            };
        }
