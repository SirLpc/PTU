...
{
    public static class Puergp_Variables_IntVariable_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new Puergp.Variables.IntVariable();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Puergp.Variables.IntVariable), result);
        ...
        private static void M_AddListener(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puergp.Variables.IntVariable;
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<UnityEngine.Events.UnityAction<int>>(false);
