...
(function (NT) {
     ...
     */
    NT.MESSAGE_ASSET_LOADER_ASSET_LOADED = "MESSAGE_ASSET_LOADER_ASSET_LOADED::";
    ...
    class AssetManager {
        ...
        static Initialize() {
            ...
            AssetManager._loaders.push(new NT.JsonAssetLoader());
            AssetManager._loaders.push(new NT.TextAssetLoader());
        }
        /**
        ...
        static onAssetLoaded(asset) {
            ...
            NT.Message.send(NT.MESSAGE_ASSET_LOADER_ASSET_LOADED + asset.Name, this, asset);
        }
        /**
